<template>
  <div class="create_book">
    ...
    <form @submit.prevent="onSubmit" class="create_book-form">
      <input type="text" v-model="name" class="create_book-item">
      <select v-model="author_id" class="create_book-item">
        <option
      ...
      <input type="date" v-model="publication_date" class="create_book-item">
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      HTTP.patch('api/books/' + this.id, body)
          .then(responce => {
